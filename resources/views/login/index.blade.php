				...
				<div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
					<div class="d-table-cell align-middle">
						...
						<div class="text-center mt-4">
							<h1 class="h2">Welcome to SIPESAT</h1>
							<p class="lead">
							...
							<div class="card-body">
								<div class="m-sm-4">
									<div class="text-center">
										<img src="adminkit/static/img/icons/logo-disdik.png" alt="Charles Hall" class="img-fluid rounded-circle" width="150" height="150" />
									</div>
